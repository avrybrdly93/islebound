...
import { defineComponent, type Store } from '@sim/ecs/ComponentDef';
 ...
 * named before this task started. `ComponentRegistry`'s cases moved to their
 * own file with the class, in BL-068.
 *
